...
category_links = "div.split-6-layout.layout div.column:nth-of-type(1) ul.menu li a::attr('href')"
# kategorijos puslapio puslapiavimo nuoroda, jeigu nėra puslapiavimo - praleisti
category_pages = ""
# kategorijų puslapių straipsnio nnuoroda
category_page_posts = "div.stream a.story-link::attr('href')"
# straipsnio pavadinimas
post_title = "h1 span::text"
# straipsnio kategorija
post_category = "#site-content div div div div span a::text"
# straipsnio nuotrauka img::attr('src')
post_image = "figure.toneNews img::attr('src')"
# straipsnio turinio blokas, galimai div[atributas='reikšmė']
post_content = "div.StoryBodyCompanionColumn div p"
